...
export const zhCN = {
    ...
    'autoTrigger.antigravityToolsSync': '自动同步 Antigravity Tools 账户',
    ...
    'atSyncConfig.dataAccessDesc': '本功能将读取您本地 Antigravity Tools 的账户信息，用于在本插件中调用 AI 模型。',
    'atSyncConfig.readPath': '读取路径',
    'atSyncConfig.readData': '读取内容',
    'atSyncConfig.readDataItems': '账户邮箱、Refresh Token',
    'atSyncConfig.autoSyncTitle': '自动同步',
    'atSyncConfig.enableAutoSync': '启用自动同步',
    'atSyncConfig.autoSyncDesc': '启用后，当您在 Antigravity Tools 中切换账号时或者添加账户时，本插件会自动同步账户并切换到对应账号。',
    'atSyncConfig.manualImportTitle': '手动导入',
    'atSyncConfig.manualImportDesc': '将 Antigravity Tools 当前正在使用的账号立即导入到本插件。仅执行一次。',
