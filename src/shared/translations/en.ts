...
export const en = {
    ...
    'autoTrigger.antigravityToolsSync': 'Auto-sync Antigravity Tools Accounts',
    ...
    'atSyncConfig.title': 'Antigravity Tools Sync Config',
    'atSyncConfig.btnText': 'Antigravity Tools Sync Config',
    'atSyncConfig.dataAccessTitle': 'Data Access Notice',
    'atSyncConfig.dataAccessDesc': 'This feature reads your local Antigravity Tools account information to call AI models in this extension.',
    'atSyncConfig.readPath': 'Read Path',
    'atSyncConfig.readData': 'Read Data',
    'atSyncConfig.readDataItems': 'Account Email, Refresh Token',
    'atSyncConfig.autoSyncTitle': 'Auto Sync',
    'atSyncConfig.enableAutoSync': 'Enable Auto Sync',
    'atSyncConfig.autoSyncDesc': 'When enabled, this extension will automatically sync and switch to the corresponding account when you switch or add accounts in Antigravity Tools.',
    'atSyncConfig.manualImportTitle': 'Manual Import',
    'atSyncConfig.manualImportDesc': 'Import the currently active account from Antigravity Tools immediately. One-time action.',
