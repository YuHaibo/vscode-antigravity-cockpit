...
export const zhTW = {
    ...
    'quotaSource.switchToAuthorized': '切換到授權',
    'quotaSource.switchToLocal': '切換到本地',
    'quotaSource.retryLocal': '重新偵測',
    'quotaSource.guideTitle': '選擇配額監控',
    'quotaSource.guideSubtitle': '選擇配額取得方式，可在右上角隨時切換。',
    'quotaSource.guideLocalTitle': '本地監控',
    'quotaSource.guideLocalDesc': '從本地 Antigravity 用戶端讀取配額。需保持用戶端運行，通常更穩定。適合桌面使用者。',
    'quotaSource.guideAuthorizedTitle': '授權監控',
    'quotaSource.guideAuthorizedDesc': '透過授權從遠端 API 取得配額。不依賴本地進程；模型更多但網路依賴較高、穩定性略低。適合 API 中轉或無用戶端環境。',
    'quotaSource.guideConfirm': '確認',
    'quotaSource.guideLater': '稍後',
    'quotaSource.switchTimeout': '切換時間較長，可再試一次。',
    ...
    'autoTrigger.noActiveAccount': '尚未選擇啟用的帳號',
    ...
    'autoTrigger.accountSwitched': '已切換帳號：{email}',
    'autoTrigger.accountDuplicate': '帳號 {email} 已存在',
    'autoTrigger.manageAccounts': '管理帳號',
    'autoTrigger.reauthorizeSuccess': '重新授權成功',
    'autoTrigger.noAccounts': '沒有已授權帳號',
    'autoTrigger.tokenExpired': '已過期',
    'autoTrigger.antigravityToolsSync': '自動同步 Antigravity Tools 帳戶',
    'autoTrigger.importFromAntigravityTools': 'Antigravity Tools 一鍵導入',
    'autoTrigger.enableAutoWakeup': '啟用自動喚醒',
    'autoTrigger.triggerMode': '喚醒方式',
    'autoTrigger.modeScheduled': '定時觸發',
    'autoTrigger.modeScheduledHint': '按設定的時間或週期進行觸發。',
    'autoTrigger.modeCrontab': 'Crontab 表達式',
    'autoTrigger.modeCrontabHint': '使用 Crontab 表達式自訂觸發時間。',
    'autoTrigger.modeQuotaReset': '配額重置自動喚醒',
    'autoTrigger.modeQuotaResetHint': '當偵測到配額恢復滿額時自動觸發。',
    ...
    'atSyncConfig.title': 'Antigravity Tools 同步配置',
    'atSyncConfig.btnText': 'Antigravity Tools 同步配置',
    'atSyncConfig.dataAccessTitle': '資料存取說明',
    'atSyncConfig.dataAccessDesc': '本功能將讀取您本地 Antigravity Tools 的帳戶資訊，用於在本外掛中呼叫 AI 模型。',
    'atSyncConfig.readPath': '讀取路徑',
    'atSyncConfig.readData': '讀取內容',
    'atSyncConfig.readDataItems': '帳戶信箱、Refresh Token',
    'atSyncConfig.autoSyncTitle': '自動同步',
    'atSyncConfig.enableAutoSync': '啟用自動同步',
    'atSyncConfig.autoSyncDesc': '啟用後，當您在 Antigravity Tools 中切換帳號或添加帳戶時，本外掛會自動同步帳戶並切換到對應帳號。',
    'atSyncConfig.manualImportTitle': '手動匯入',
    'atSyncConfig.manualImportDesc': '將 Antigravity Tools 目前正在使用的帳號立即匯入到本外掛。僅執行一次。',
    'atSyncConfig.importNow': '立即匯入帳戶',
};