...
微信 1~5 群扫码均已满员，目前可通过以下方式加入：

1. **QQ 群过渡**：先加入 QQ 群过渡，群内会想办法让大家加入微信群
2. **加作者微信**：添加作者微信好友，备注来意，手动拉群（每日限 10 人，避免风控）

| QQ 群 | 作者微信 |
| :---: | :---: |
| <img src="docs/qq_group.png" width="200" /> | <img src="docs/wechat_.jpg" width="200" /> | 
